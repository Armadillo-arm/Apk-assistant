...
public class MiniType
   {
      //打开文件时调用
      public static void openFiles (Context thzz, String filesPath )
         {
            ...
            if ( !type.equals ( "*/*" ) )
               {
                  try
                     ...
                     {
                      thzz.  startActivity ( showOpenTypeDialog ( filesPath ) );
                     }
               }
            else
               {
...
//显示打开方式
      public static void show (Context thzz, String filesPath )
         {
            Intent intent = new Intent ( );
            intent.addFlags ( Intent.FLAG_ACTIVITY_NEW_TASK );
            intent.setAction ( Intent.ACTION_VIEW );
